...
For a detailed idea, we refer readers to [this article](https://arxiv.org/abs/2605.00260). Complete user documentation can be found [here](https://nlpoptnet.readthedocs.io/).
